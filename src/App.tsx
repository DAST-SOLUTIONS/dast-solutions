...
// ============================================================================
// NOUVELLES PAGES - PHASES 1-4 (AI Takeoff & Estimation Avancés)
// ============================================================================
    ...
    <ThemeProvider>
      <Router>
        ...
        <Route path="/" element={session ? <Layout /> : <Navigate to="/login" />}>
          ...
          {/* ============================================================ */}
          <Route path="takeoff-advanced" element={<TakeoffViewerAdvanced />} />
          <Route path="takeoff-advanced/:projectId" element={<TakeoffViewerAdvanced />} />
          <Route path="ai-takeoff" element={<AITakeoff />} />
          <Route path="ai-takeoff/:projectId" element={<AITakeoff />} />
          <Route path="estimation-advanced" element={<EstimationAdvanced />} />
